...
import prefuse.event.ControlEventMulticaster;
import prefuse.event.ControlListener;
import prefuse.render.Renderer;
import prefuse.util.ColorLib;
import prefuse.util.FontLib;
import prefuse.util.display.Clip;
import prefuse.util.display.ExportDisplayAction;
import prefuse.util.display.ToolTipManager;
 ...
 * {@link prefuse.ItemRegistry ItemRegistry} from 
 * which it pulls the items to visualize.</p>
 * 
 * <p>The {@link prefuse.event.ControlListener ControlListener}
 * interface provides the various available user interface callbacks. The
 * {@link prefusex.controls} package contains a number
 ...
 * @see ItemRegistry
 * @see prefuse.event.ControlListener
 * @see prefusex.controls
 */
