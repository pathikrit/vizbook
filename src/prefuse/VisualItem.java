 ...
 * {@link prefuse.graph.Entity Entity} interface, but act as
...
public abstract class VisualItem implements Entity {
     ...
     * @see prefuse.graph.Entity#getAttributes()
     */
     ...
     * @see prefuse.graph.Entity#setAttributes(java.util.Map)
     */
     ...
     * @see prefuse.graph.Entity#clearAttributes()
     */
     ...
     * occurs whenever a {@link prefuse.action.Filter
     * Filter} is run.
