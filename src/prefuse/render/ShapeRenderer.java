 ...
 * {@link #getRawShape(prefuse.VisualItem) getRawShape}
 * which return the shape to draw. Optionally, subclasses can also override the
 * {@link #getTransform(prefuse.VisualItem)
...
public abstract class ShapeRenderer implements Renderer {
	...
	/**
	 * @see prefuse.render.Renderer#render(java.awt.Graphics2D, prefuse.VisualItem)
	 */
	...
	/**
	 * @see prefuse.render.Renderer#locatePoint(java.awt.geom.Point2D, prefuse.VisualItem)
	 */
	...
	/**
	 * @see prefuse.render.Renderer#getBoundsRef(prefuse.VisualItem)
	 */
