package prefuse.graph;

import java.util.Collections;
import java.util.Iterator;
import java.util.LinkedList;

import prefuse.collections.BreadthFirstTreeIterator;
import prefuse.collections.TreeEdgeIterator;
...
public class DefaultTree extends AbstractGraph implements Tree {
     ...
     * @see prefuse.graph.Graph#isDirected()
	 */
	 ...
	 * @see prefuse.graph.Graph#getNodeCount()
	 */
	 ...
	 * nodes minus one.
	 * @see prefuse.graph.Graph#getEdgeCount()
	 */
	 ...
	 * @see prefuse.graph.Graph#getEdges()
	 */
    ...
    /**
     * @see prefuse.graph.Tree#addChild(prefuse.graph.Edge)
     */
    ...
    /**
     * @see prefuse.graph.Tree#addChild(prefuse.graph.Node, prefuse.graph.Node)
     */
    ...
    /**
     * @see prefuse.graph.Tree#removeChild(prefuse.graph.Edge)
     */
     ...
     * @see prefuse.graph.Graph#addNode(prefuse.graph.Node)
     */
    ...
    /**
     * @see prefuse.graph.Graph#addEdge(prefuse.graph.Edge)
     */
    ...
    /**
     * @see prefuse.graph.Graph#removeNode(prefuse.graph.Node)
     */
    ...
    /**
     * @see prefuse.graph.Graph#removeEdge(prefuse.graph.Edge)
     */
    ...
    /**
     * @see prefuse.graph.Graph#replaceNode(prefuse.graph.Node, prefuse.graph.Node)
     */
    ...
    /**
     * @see prefuse.graph.Graph#replaceEdge(prefuse.graph.Edge, prefuse.graph.Edge)
     */
    ...
    /**
     * @see prefuse.graph.Graph#contains(prefuse.graph.Node)
     */
    ...
    /**
     * @see prefuse.graph.Graph#contains(prefuse.graph.Edge)
     */
