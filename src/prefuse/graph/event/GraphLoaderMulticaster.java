...
import prefuse.event.EventMulticaster;
import prefuse.graph.Entity;
import prefuse.graph.external.GraphLoader;
    ...
    implements GraphLoaderListener
{
    ...
    /**
     * @see prefuse.graph.event.GraphLoaderListener#entityLoaded(prefuse.graph.external.GraphLoader, prefuse.graph.Entity)
     */
    ...
    /**
     * @see prefuse.graph.event.GraphLoaderListener#entityUnloaded(prefuse.graph.external.GraphLoader, prefuse.graph.Entity)
     */
