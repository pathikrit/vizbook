...
public class PrefuseEventLogger implements ControlListener, 
	...
	/**
	 * @see prefuse.event.ItemRegistryListener#registryItemAdded(prefuse.VisualItem)
	 */
	...
	/**
	 * @see prefuse.event.ItemRegistryListener#registryItemRemoved(prefuse.VisualItem)
	 */
    ...
    /**
     * @see prefuse.event.FocusListener#focusChanged(prefuse.event.FocusEvent)
     */
